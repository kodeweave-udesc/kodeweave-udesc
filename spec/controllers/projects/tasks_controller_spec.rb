...
RSpec.describe Projects::TasksController, type: :controller do
  ...
  # Projects::Task. As you add validations to Projects::Task, be sure to
  ...
  # Projects::TasksController. Be sure to keep this updated too.
  let(:valid_session) { {} }

  describe "GET #index" do
    it "returns a success response" do
      Projects::Task.create! valid_attributes
  ...
  describe "GET #show" do
    it "returns a success response" do
      task = Projects::Task.create! valid_attributes
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Projects::Task" do
        expect {
          post :create, params: {project_task: valid_attributes}, session: valid_session
        }.to change(Projects::Task, :count).by(1)
      end

      it "redirects to the created project_task" do
        post :create, params: {project_task: valid_attributes}, session: valid_session
        expect(response).to redirect_to(Projects::Task.last)
      end
    end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested project_task" do
        task = Projects::Task.create! valid_attributes
        put :update, params: {id: task.to_param, project_task: new_attributes}, session: valid_session
        task.reload
      ...
      it "redirects to the project_task" do
        task = Projects::Task.create! valid_attributes
        put :update, params: {id: task.to_param, project_task: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'edit' template)" do
        task = Projects::Task.create! valid_attributes
        put :update, params: {id: task.to_param, project_task: invalid_attributes}, session: valid_session
        expect(response).to be_successful
      end
    end
  end
